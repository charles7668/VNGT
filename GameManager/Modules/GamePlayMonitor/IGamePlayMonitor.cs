...
namespace GameManager.Modules.GamePlayMonitor
{
    public interface IGamePlayMonitor
    {
        ...
        /// <param name="onStopCallback">The callback to invoke when the process stops.</param>
        /// <returns>A result indicating the success or failure of the operation.</returns>
        Task<Result> AddMonitorItem(int gameId, string gameName, int pid, Action<GameStopEventArgs>? onStopCallback);
        ...
        /// <param name="onStopCallback">The callback to invoke when the process stops.</param>
        void RegisterCallback(int gameId, Action<GameStopEventArgs> onStopCallback);

        /// <summary>
        /// Unregisters a callback for a specific game.
        /// </summary>
        /// <param name="gameId">The ID of the game to unregister the callback for.</param>
        /// <param name="onStopCallback">The callback to remove.</param>
        void UnregisterCallback(int gameId, Action<GameStopEventArgs> onStopCallback);
